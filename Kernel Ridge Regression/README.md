This folder contains an implementation of Kernel Ridge Regression and Kernel Smoothing in `R`, as well as a demonstration of these algorithms in a `Shiny` web app.
