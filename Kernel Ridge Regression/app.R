...
ui <- fluidPage(
    ...
    sidebarLayout(
        ...
        mainPanel(
           ...
           HTML("<p>The code for the app and the implementation in <code>R</code> of the smoothing and ridge regression algorithms can be found on <a href='https://github.com/maxweissenbacher/max-learning-library/tree/main/Kernel%20Ridge%20Regression'>GitHub</a>.")
        )
    )
)
